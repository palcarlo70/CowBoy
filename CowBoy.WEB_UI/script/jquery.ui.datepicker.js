...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		prevText: "Avan", // Display text for previous month link
		nextText: "Ind", // Display text for next month link
		...
		dayNames: ["Domenica", "Lunedì", "Martdì", "Mercoledì", "Giovedì", "Venerdì", "Sabato"], // For formatting
