...
namespace CowBoyWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ContentResult GetBovini(int? idAnagrafica, string sesso, int? manze, int? inLattazione, int? inAsciutta, string ricercaLibera, int? inAzienda)
        {
            ...
            //return Content(JsonConvert.SerializeObject(idAnagrafica == null ? (object)lst : lst.FirstOrDefault(), _jsonSetting), "application/json");
            return Content(idAnagrafica == null ? JsonConvert.SerializeObject(lst, _jsonSetting) : JsonConvert.SerializeObject(lst.FirstOrDefault(), _jsonSetting), "application/json");
        }
